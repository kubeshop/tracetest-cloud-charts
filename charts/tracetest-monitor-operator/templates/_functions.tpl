...
*/}}
{{- define "tracetest-monitor-operator.postgres_dsn" -}}
...
*/}}
{{- define "tracetest-monitor-operator.mongodb_dsn" -}}
...
*/}}
{{- define "tracetest-monitor-operator.url" -}}
...
{{/*
Create a connection string for Nats
*/}}
{{- define "tracetest-monitor-operator.nats_endpoint" -}}
