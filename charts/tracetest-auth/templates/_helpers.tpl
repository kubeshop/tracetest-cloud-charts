...
*/}}
{{- define "tracetest-auth.fullname" -}}
...
Common labels
*/}}
{{- define "tracetest-auth.labels" -}}
helm.sh/chart: {{ include "tracetest-auth.chart" . }}
{{ include "tracetest-auth.selectorLabels" . }}
{{- if .Chart.AppVersion }}
